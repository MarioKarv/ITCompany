...
namespace ITCompany.Controllers
{
    ...
    {
        private ITCompanyContext db;
        IHostingEnvironment Environment;
        public AccountController(ITCompanyContext context, IHostingEnvironment _environment)
        {
            db = context;
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            {
                User user = await db.Users.Include(u => u.Role).FirstOrDefaultAsync(u => u.Login == model.Login && u.Password.Equals(model.Password));
                if (user != null)
                {
